...
const CONFIG = {
  ...
  OHLC_LABEL_COLOR: '#999',
  OHLC_LABEL_VALUE_COLOR: '#fff',
  OHLC_LABEL_FONT_NAME: 'sans-serif',
  OHLC_LABEL_FONT_SIZE_PX: 12,
  OHLC_LABEL_POSITION_X: 32,
  OHLC_LABEL_POSITION_Y: 32,
  OHLC_LABEL_SPACING: 4,
  CROSSHAIR_COLOR: '#666',
  MARGIN_BOTTOM: 25,
  MARGIN_RIGHT: 80,
